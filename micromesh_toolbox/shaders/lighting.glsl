...
#include "nvvkhl/shaders/func.glsl"              // misc functions
#include "nvvkhl/shaders/dh_lighting.h"          // struct VisibilityContribution
#include "pbr_mat_struct.h"                      // struct PbrMaterial
#include "nvvkhl/shaders/hdr_env_sampling.glsl"  // Environment Sample
#include "nvvkhl/shaders/light_contrib.glsl"     // light contribution
