...
def store_micromesh_primvars(micromesh_data : pymm.MicromeshData, prim : Usd.Prim):
    ...
    primvarsapi.CreatePrimvar('micromesh:triangleFlagsByteAlignment', Sdf.ValueTypeNames.UInt).Set(triangle_flag_byte_alignment)
    ...
    primvarsapi.CreatePrimvar('micromesh:triangleMinMaxsByteAlignment', Sdf.ValueTypeNames.UInt).Set(triangle_min_max_byte_alignment)
    ...
    primvarsapi.CreatePrimvar('micromesh:valueByteAlignment', Sdf.ValueTypeNames.UInt).Set(value_byte_alignment)   
